...
subroutine qmecha_version()
   ...
   call write_simple_line(stdout,0,mpi_rank,8,"l","                                      (Open Version 0.1) ")
   call write_empty_line(stdout,0,mpi_rank)
   call write_simple_line(stdout,0,mpi_rank,2,"l","@Author             : Matteo Barborini (matteo.barborini@gmail.com)")
   call write_empty_line(stdout,0,mpi_rank)
   call write_simple_line(stdout,0,mpi_rank,2,"l","@Private repository : https://github.com/QMeCha/QMeCha_open    ")
   call write_empty_line(stdout,0,mpi_rank)
   call write_simple_strn_line(stdout,0,mpi_rank,2,"Compilation date","13-Nov-2025",25)
